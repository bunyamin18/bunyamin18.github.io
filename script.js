...
async function sendContactEmail(formId) {
    ...
    const templateParams = {
        from_name: formData.get('name') || document.getElementById(formId.includes('Home') ? 'contactNameHome' : 'contactName')?.value,
        from_email: formData.get('email') || document.getElementById(formId.includes('Home') ? 'contactEmailHome' : 'contactEmail')?.value,
        subject: formData.get('subject') || document.getElementById(formId.includes('Home') ? 'contactSubjectHome' : 'contactSubject')?.value,
        message: formData.get('message') || document.getElementById(formId.includes('Home') ? 'contactMessageHome' : 'contactMessage')?.value
    };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactFormHome) {
        contactFormHome.addEventListener('submit', (e) => {
            e.preventDefault();
            sendContactEmail('contactFormHome');
        });
    }
